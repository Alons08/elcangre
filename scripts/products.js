...
const products = [
    ...
    {id: 40, name: "Ceviche de pescado ahuancainado personal", category: "ceviches", price: 32, description: "Ceviche de pescado con salsa huancaína.", image: "./images/menu/ceviche-huancainado.jpg", available: true},
    {id: 34, name: "Ceviche de pescado ahuancainado fuente", category: "ceviches", price: 65, description: "Ceviche de pescado con salsa huancaína.", image: "./images/menu/ceviche-huancainado.jpg", available: true},
    {id: 36, name: "Ceviche mixto ahuancainado personal", category: "ceviches", price: 36, description: "Ceviche mixto con salsa huancaína.", image: "./images/menu/ceviche-huancainado.jpg", available: true},
    {id: 37, name: "Ceviche mixto ahuancainado fuente", category: "ceviches", price: 70, description: "Ceviche mixto con salsa huancaína fuente.", image: "./images/menu/ceviche-huancainado.jpg", available: true},
