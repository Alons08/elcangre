...
const products = [
    // Arroces
    {id: 1, name: "Arroz con langostinos fuente", category: "arroces", price: 65, description: "Arroz con langostinos frescos y especias.", image: "./images/menu/arroz-langostinos-fuente.jpg", available: true},
    {id: 2, name: "Arroz con langostinos personal", category: "arroces", price: 30, description: "Porción personal de arroz con langostinos.", image: "./images/menu/arroz-langostinos-personal.jpg", available: true},
    {id: 3, name: "Arroz con choros personal", category: "arroces", price: 30, description: "Arroz con choros y toque de la casa.", image: "./images/menu/arroz-choros-personal.jpg", available: true},
    {id: 4, name: "Arroz con choros fuente", category: "arroces", price: 65, description: "Fuente de arroz con choros frescos.", image: "./images/menu/arroz-choros-fuente.jpg", available: true},
    {id: 5, name: "Arroz con marisco fuente", category: "arroces", price: 60, description: "Arroz con mariscos variados y especias.", image: "./images/menu/arroz-marisco-fuente.jpg", available: true},
    {id: 6, name: "Arroz con marisco personal", category: "arroces", price: 28, description: "Porción personal de arroz con mariscos.", image: "./images/menu/arroz-marisco-personal.jpg", available: true},
    {id: 7, name: "Chaufa de pescado fuente", category: "arroces", price: 65, description: "Chaufa de pescado al estilo oriental.", image: "./images/menu/chaufa-pescado-fuente.jpg", available: true},
    {id: 8, name: "Chaufa de pescado personal", category: "arroces", price: 30, description: "Porción personal de chaufa de pescado.", image: "./images/menu/chaufa-pescado-personal.jpg", available: true},
    {id: 9, name: "Chaufa de mariscos fuente", category: "arroces", price: 65, description: "Chaufa de mariscos con verduras.", image: "./images/menu/chaufa-mariscos-fuente.jpg", available: true},
    {id: 10, name: "Chaufa de mariscos personal", category: "arroces", price: 30, description: "Porción personal de chaufa de mariscos.", image: "./images/menu/chaufa-mariscos-personal.jpg", available: true},
    ...
    {id: 13, name: "Cerveza Trigo", category: "bebidas", price: 10, description: "Cerveza de trigo bien fría.", image: "./images/menu/cerveza-trigo.jpg", available: true},
    {id: 14, name: "Cerveza Negra", category: "bebidas", price: 10, description: "Cerveza negra nacional.", image: "./images/menu/cerveza-negra.jpg", available: true},
    ...
    {id: 16, name: "Chicha morada 500ml", category: "bebidas", price: 5, description: "Chicha morada natural 500ml.", image: "./images/menu/chicha-morada-500.jpg", available: true},
    {id: 17, name: "Chicha morada 1L", category: "bebidas", price: 10, description: "Chicha morada natural 1L.", image: "./images/menu/chicha-morada-1l.jpg", available: true},
    {id: 18, name: "Gaseosa Inka cola 1L", category: "bebidas", price: 8, description: "Inka Kola 1L fría.", image: "./images/menu/inka-kola-1l.jpg", available: true},
    ...
    {id: 20, name: "Gaseosa Coca cola 1L", category: "bebidas", price: 8, description: "Coca Cola 1L fría.", image: "./images/menu/coca-cola-1l.jpg", available: true},

    // Ceviches
    {id: 21, name: "Ceviche de pescado natural fuente", category: "ceviches", price: 55, description: "Ceviche de pescado fresco, fuente.", image: "./images/menu/ceviche-pescado-fuente.jpg", available: true},
    {id: 22, name: "Ceviche mixto en crema de rocoto personal", category: "ceviches", price: 36, description: "Ceviche mixto con crema de rocoto.", image: "./images/menu/ceviche-mixto-rocoto-personal.jpg", available: true},
    {id: 23, name: "Ceviche mixto natural personal", category: "ceviches", price: 30, description: "Ceviche mixto clásico personal.", image: "./images/menu/ceviche-mixto-personal.jpg", available: true},
    {id: 24, name: "Ceviche mixto natural fuente", category: "ceviches", price: 60, description: "Ceviche mixto clásico fuente.", image: "./images/menu/ceviche-mixto-fuente.jpg", available: true},
    {id: 25, name: "Ceviche mixto en crema de rocoto fuente", category: "ceviches", price: 70, description: "Ceviche mixto con crema de rocoto fuente.", image: "./images/menu/ceviche-mixto-rocoto-fuente.jpg", available: true},
    {id: 26, name: "Ceviche mixto en leche de tigre personal", category: "ceviches", price: 33, description: "Ceviche mixto en leche de tigre.", image: "./images/menu/ceviche-mixto-lechetigre-personal.jpg", available: true},
    {id: 27, name: "Ceviche mixto en leche de tigre fuente", category: "ceviches", price: 65, description: "Ceviche mixto en leche de tigre fuente.", image: "./images/menu/ceviche-mixto-lechetigre-fuente.jpg", available: true},
    {id: 28, name: "Ceviche mixto acangrejao fuente", category: "ceviches", price: 70, description: "Ceviche mixto con cangrejo fuente.", image: "./images/menu/ceviche-mixto-acangrejao-fuente.jpg", available: true},
    {id: 29, name: "Ceviche mixto tricolor personal", category: "ceviches", price: 55, description: "Ceviche mixto con tres sabores.", image: "./images/menu/ceviche-mixto-tricolor-personal.jpg", available: true},
    {id: 30, name: "Ceviche mixto tricolor fuente", category: "ceviches", price: 90, description: "Ceviche mixto tricolor fuente.", image: "./images/menu/ceviche-mixto-tricolor-fuente.jpg", available: true},
    {id: 31, name: "Ceviche mixto de cangrejos personal", category: "ceviches", price: 40, description: "Ceviche mixto con cangrejo personal.", image: "./images/menu/ceviche-mixto-cangrejo-personal.jpg", available: true},
    {id: 32, name: "Ceviche mixto acangrejao personal", category: "ceviches", price: 35, description: "Ceviche mixto con cangrejo personal.", image: "./images/menu/ceviche-mixto-acangrejao-personal.jpg", available: true},
    ...
    {id: 34, name: "Ceviche de pescado ahuancainado fuente", category: "ceviches", price: 65, description: "Ceviche de pescado con salsa huancaína.", image: "./images/menu/ceviche-pescado-huancainado-fuente.jpg", available: true},
    {id: 35, name: "Ceviche mixto de cangrejos fuente", category: "ceviches", price: 80, description: "Ceviche mixto con cangrejo fuente.", image: "./images/menu/ceviche-mixto-cangrejo-fuente.jpg", available: true},
    {id: 36, name: "Ceviche mixto ahuancainado personal", category: "ceviches", price: 36, description: "Ceviche mixto con salsa huancaína.", image: "./images/menu/ceviche-mixto-huancainado-personal.jpg", available: true},
    {id: 37, name: "Ceviche mixto ahuancainado fuente", category: "ceviches", price: 70, description: "Ceviche mixto con salsa huancaína fuente.", image: "./images/menu/ceviche-mixto-huancainado-fuente.jpg", available: true},
    {id: 38, name: "Ceviche de pescado en crema de rocoto personal", category: "ceviches", price: 32, description: "Ceviche de pescado con crema de rocoto.", image: "./images/menu/ceviche-pescado-rocoto-personal.jpg", available: true},
    {id: 39, name: "Ceviche de pescado en crema de rocoto fuente", category: "ceviches", price: 65, description: "Ceviche de pescado con crema de rocoto fuente.", image: "./images/menu/ceviche-pescado-rocoto-fuente.jpg", available: true},
    {id: 40, name: "Ceviche de pescado ahuancainado personal", category: "ceviches", price: 32, description: "Ceviche de pescado con salsa huancaína.", image: "./images/menu/ceviche-pescado-huancainado-personal.jpg", available: true},
    {id: 41, name: "Ceviche de pescado en leche de tigre personal", category: "ceviches", price: 30, description: "Ceviche de pescado en leche de tigre.", image: "./images/menu/ceviche-pescado-lechetigre-personal.jpg", available: true},
    {id: 42, name: "Ceviche de pescado en leche de tigre fuente", category: "ceviches", price: 60, description: "Ceviche de pescado en leche de tigre fuente.", image: "./images/menu/ceviche-pescado-lechetigre-fuente.jpg", available: true},
    {id: 43, name: "Cevimaruchas a huancainadas", category: "ceviches", price: 30, description: "Cevimaruchas con salsa huancaína.", image: "./images/menu/cevimaruchas-huancainadas.jpg", available: true},
